...
export default function FreeTrialForm(): JSX.Element {
  ...
  const [isSelf, setIsSelf] = useState(false) // State for adding a second student
  const [studentCount, setStudentCount] = useState(1) // State for adding a second student
  interface FormData {
    first_name: string
    last_name: string
    email: string
