  ...
  return (
    <div className='md:flex lg:w-2/3 mx-auto'>
      <ul className='flex-column space-y space-y-4 text-sm font-medium text-gray-500 dark:text-gray-400 md:me-4 mb-4 md:mb-0'>
        <li>
          <a
            className={`inline-flex items-center px-4 py-3 rounded-lg w-full cursor-pointer hover:text-white hover:bg-accent transition-all duration-700 ${selected === 'guitar' ? 'text-white bg-accent' : 'bg-secondary'}`}
            aria-current='page'
