...
export default function PrivacyPolicyPage() {
  return (
    <main className='container mt-24 py-24'>
      <div className='max-w-prose space-y-6 text-xl'>
        <h1 className='text-5xl text-accent font-bold'>Privacy Policy</h1>
        <p className='text-muted-foreground'>
          Last updated: <time dateTime='2024-12-12'>December 12, 2024</time>
        </p>
        <p className='font-bold tracking-wide leading-relaxed'>
        ...
        <ul className='list-none space-y-2'>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Rockstars La Verne, accessible
              from{' '}
              <a
                href='https://rockstarslaverne.com'
                rel='internal'
                className='underline hover:no-underline'
              >
                https://rockstarslaverne.com
              </a>
            </p>
          </li>
          <li>
        ...
        <h4 className='text-2xl tracking-wide'>Personal Data</h4>
        <p>
        ...
        <h4 className='text-2xl tracking-wide'>Usage Data</h4>
        ...
        <h3 className='text-2xl font-bold'>Use of Your Personal Data</h3>
        ...
        <h3 className='text-2xl font-bold'>Retention of Your Personal Data</h3>
        <p>
        ...
        <h3 className='text-2xl font-bold'>Transfer of Your Personal Data</h3>
        <p>
        ...
        <h3 className='text-2xl font-bold'>Delete Your Personal Data</h3>
        <p>
        ...
        <h3 className='text-2xl font-bold'>Disclosure of Your Personal Data</h3>
        <h4 className='text-2xl tracking-wide'>Business Transactions</h4>
        <p>
        ...
        <h4 className='text-2xl tracking-wide'>Law enforcement</h4>
        <p>
          Under certain circumstances, the Company may be required to disclose
          Your Personal Data if required to do so by law or in response to valid
          requests by public authorities (e.g. a court or a government agency).
        </p>
        <h4 className='text-2xl tracking-wide'>Other legal requirements</h4>
        <p>
        ...
        <ul className='list-none space-y-2'>
          <li>
            <p>By email: laverne@rockstarsoftomorrow.com</p>
          </li>
          <li>
            <p>
